...
/* Load and fill RAM_D1 */

  ldr r0, =_sdata_RAM_D1
  ldr r1, =_edata_RAM_D1
  ldr r2, =_sidata_RAM_D1
  movs r3, #0
...
/* Load and fill RAM_D2 */

  ldr r0, =_sdata_RAM_D2
  ldr r1, =_edata_RAM_D2
  ldr r2, =_sidata_RAM_D2
  movs r3, #0
...
/* Load and fill RAM_D3 */

  ldr r0, =_sdata_RAM_D3
  ldr r1, =_edata_RAM_D3
  ldr r2, =_sidata_RAM_D3
  movs r3, #0
