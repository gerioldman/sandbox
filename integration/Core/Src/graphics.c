...
static void write_buffer(uint16_t x, uint16_t y, uint16_t colour)
{
	display_buffer0[y * 480 + 2 * x] = (uint8_t)((colour & 0xFF00) >> 8);
	display_buffer0[y * 480 + 2 * x + 1] = (uint8_t)colour & 0xFF;
}
...
{
	cube_mesh return_cube =
		{
			.triangles[0] = {.p[0] =  {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[1] = {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[2] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}},
			.triangles[1] = {.p[0] =  {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[1] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[2] = {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}},
			.triangles[2] = {.p[0] =  {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[1] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[2] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}},
			.triangles[3] = {.p[0] =  {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[1] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[2] = {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}},
			.triangles[4] = {.p[0] =  {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[1] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[2] = {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}},
			.triangles[5] = {.p[0] =  {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[1] = {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[2] = {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}},
			.triangles[6] = {.p[0] =  {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[1] = {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[2] = {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}},
			.triangles[7] = {.p[0] =  {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[1] = {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[2] = {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}},
			.triangles[8] = {.p[0] =  {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[1] = {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[2] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}},
			.triangles[9] = {.p[0] =  {0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[1] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[2] = {size - size/sqrtf(3.0f), size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}},
			.triangles[10] = {.p[0] = {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[1] = {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[2] = {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}},
			.triangles[11] = {.p[0] = {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), size - size/sqrtf(3.0f)}, .p[1] = {0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}, .p[2] = {size - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f), 0.0f - size/sqrtf(3.0f)}}};
	return return_cube;
}
...
void Graphics_Draw(Orientation_Data_t orientation_data)
{
	...
	matRotZ.mat[0][0] = cosf(-orientation_data.phiHat);
	matRotZ.mat[0][1] = sinf(-orientation_data.phiHat);
	matRotZ.mat[0][2] = 0;
	matRotZ.mat[0][3] = 0;
	matRotZ.mat[1][0] = -sinf(-orientation_data.phiHat);
	matRotZ.mat[1][1] = cosf(-orientation_data.phiHat);
	matRotZ.mat[1][2] = 0;
	matRotZ.mat[1][3] = 0;
	matRotZ.mat[2][0] = 0;
	matRotZ.mat[2][1] = 0;
	...
	matRotX.mat[0][3] = 0;
	matRotX.mat[1][0] = 0;
	matRotX.mat[1][1] = cosf(-orientation_data.thetaHat);
	matRotX.mat[1][2] = sinf(-orientation_data.thetaHat);
	matRotX.mat[1][3] = 0;
	matRotX.mat[2][0] = 0;
	matRotX.mat[2][1] = -sinf(-orientation_data.thetaHat);
	matRotX.mat[2][2] = cosf(-orientation_data.thetaHat);
	matRotX.mat[2][3] = 0;
	matRotX.mat[3][0] = 0;
	matRotX.mat[3][1] = 0;
	matRotX.mat[3][2] = 0;
	...
	{
		display_buffer0[i] = 0x00;
		display_buffer0[i + 1] = 0x00;
	}
	...
	for (int i = 0; i < 12; i++)
	{
		...
		if (((normal.x * triTranslated.p[0].x - camera.x) + (normal.y * triTranslated.p[0].y - camera.y) + (normal.z * triTranslated.p[0].z - camera.z)) < 0.0f)
		{
			...
			Graphics_Draw_FilledTriangle(
				(int)triProjected.p[0].x,
