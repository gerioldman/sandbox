...
static MPU6050_StatusTypeDef MPU6050_IsConnected();
...
MPU6050_StatusTypeDef MPU6050_Init(MPU6050_InitTypeDef *init_struct)
{
    ...
    else
    {
        ...
        if (I2C_Write(MPU6050_ADDRESS << 1, SMPLRT_DIV_ADDRESS, 1, &init_struct->smplrt_div.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }
        ...
        if (I2C_Write(MPU6050_ADDRESS << 1, CONFIG_ADDRESS, 1, &init_struct->config.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }
        ...
        if (I2C_Write(MPU6050_ADDRESS << 1, GYRO_CONFIG_ADDRESS, 1, &init_struct->gyro_config.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }
        ...
        if (I2C_Write(MPU6050_ADDRESS << 1, ACCEL_CONFIG_ADDRESS, 1, &init_struct->accel_config.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }
        ...
        if (I2C_Write(MPU6050_ADDRESS << 1, FIFO_EN_ADDRESS, 1, &init_struct->fifo_en.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }
        ...
        if (I2C_Write(MPU6050_ADDRESS << 1, I2C_MST_CTRL_ADDRESS, 1, &init_struct->i2c_mst_ctrl.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }
        ...
        if (I2C_Write(MPU6050_ADDRESS << 1, USER_CTRL_ADDRESS, 1, &init_struct->user_ctrl.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }

        if (I2C_Write(MPU6050_ADDRESS << 1, PWR_MGMT_1_ADDRESS, 1, &init_struct->pwr_mgmt_1.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }

        if (I2C_Write(MPU6050_ADDRESS << 1, PWR_MGMT_2_ADDRESS, 1, &init_struct->pwr_mgmt_2.Byte, 1, 1000) != I2C_OK)
        {
            return MPU6050_ERROR;
        }
    }
